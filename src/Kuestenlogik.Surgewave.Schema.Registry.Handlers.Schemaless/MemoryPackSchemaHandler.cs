...
/// <summary>
/// Schema type handler for MemoryPack (schemaless binary) serialization.
/// MemoryPack uses source generation and handles versioning internally,
/// so validation always succeeds and compatibility is always maintained.
/// </summary>
public sealed class MemoryPackSchemaHandler : ISchemaTypeHandler
{
    /// <inheritdoc />
    public string TypeName => "MEMORYPACK";

    /// <inheritdoc />
    /// <remarks>
    /// MemoryPack is schemaless — any schema string is accepted.
    ...
    /// <inheritdoc />
    /// <remarks>
    /// MemoryPack is self-describing and handles versioning internally,
