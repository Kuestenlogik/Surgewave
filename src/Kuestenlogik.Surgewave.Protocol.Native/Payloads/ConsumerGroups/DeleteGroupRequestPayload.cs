...
/// <summary>
/// Wire format for DeleteGroup request.
/// Shared between client (write) and broker (read) to ensure consistency.
/// </summary>
public readonly record struct DeleteGroupRequestPayload
{
    ...
    /// </summary>
    public static DeleteGroupRequestPayload Read(ref SurgewavePayloadReader reader)
    {
        return new DeleteGroupRequestPayload
        {
