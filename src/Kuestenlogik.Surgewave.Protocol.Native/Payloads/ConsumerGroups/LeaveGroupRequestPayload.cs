...
/// <summary>
/// Wire format for LeaveGroup request.
/// Shared between client (write) and broker (read) to ensure consistency.
/// </summary>
public readonly record struct LeaveGroupRequestPayload
{
    ...
    /// </summary>
    public static LeaveGroupRequestPayload Read(ref SurgewavePayloadReader reader)
    {
