...
/// <summary>
/// Wire format for DeleteGroup response.
/// Shared between broker (write) and client (read) to ensure consistency.
/// </summary>
public readonly record struct DeleteGroupResponsePayload
{
    ...
    /// </summary>
    public static DeleteGroupResponsePayload Read(ref SurgewavePayloadReader reader)
    {
        return new DeleteGroupResponsePayload
        {
