...
/// <summary>
/// Wire format for Heartbeat response.
/// Shared between broker (write) and client (read) to ensure consistency.
/// </summary>
public readonly record struct HeartbeatResponsePayload
{
    ...
    /// </summary>
    public static HeartbeatResponsePayload Read(ref SurgewavePayloadReader reader)
    {
