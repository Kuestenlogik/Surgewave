...
/// <summary>
/// Wire format for AlterConfig request containing topic name and config updates.
/// Shared between broker (read) and client (write) to ensure consistency.
/// </summary>
public readonly record struct AlterConfigRequestPayload
{
    ...
    /// </summary>
    public static AlterConfigRequestPayload Read(ref SurgewavePayloadReader reader)
    {
        ...
        return new AlterConfigRequestPayload
        {
            TopicName = topicName,
            Configs = configs
        };
