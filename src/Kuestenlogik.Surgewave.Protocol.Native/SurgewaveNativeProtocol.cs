...
///
/// Wire Format:
/// - Magic: "SRWV" (4 bytes) - only on first message after connection
...
{
    /// <summary>
    /// Magic bytes to identify Surgewave native protocol: "SRWV"
    /// </summary>
    public static ReadOnlySpan<byte> Magic => "SRWV"u8;
