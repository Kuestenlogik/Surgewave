...
public sealed class NativePluginHandler : NativeHandlerBase
{
    ...
    public NativePluginHandler(ConnectorRepositoryManager? repositoryManager = null, bool pluginsEnabled = false)
    {
        ...
        if (repositoryManager != null)
        {
            Register<SearchPluginsRequestPayload, PluginOps.SearchPluginsResult>(
                SurgewaveOpCode.SearchPlugins, _ => new PluginOps.SearchPluginsOperation(repositoryManager));
