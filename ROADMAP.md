...
- [#156](https://github.com/Kuestenlogik/Surgewave/issues/156) **Move the eleven sibling repos off their hand-written zip step onto PackPlugin** `area:plugin-sdk` `track:plugin-distribution`
- [#157](https://github.com/Kuestenlogik/Surgewave/issues/157) **plugins install defaults to a directory the broker never reads** `area:cli`
- [#158](https://github.com/Kuestenlogik/Surgewave/issues/158) **Separate installation, machine state and user data for plugins — the service does not run as the admin who installed them** 

---

*Generated 2026-08-25 from [Project #4](https://github.com/orgs/Kuestenlogik/projects/4).*
