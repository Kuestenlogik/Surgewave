...
- [#158](https://github.com/Kuestenlogik/Surgewave/issues/158) **Separate installation, machine state and user data for plugins — the service does not run as the admin who installed them** `area:plugin-sdk` `track:plugin-distribution`
