...
Before we can accept your contribution, you must sign our Contributor License Agreement (CLA). This is required because Surgewave is licensed under the [Business Source License 1.1](LICENSE) (BSL 1.1).

**What this means:**
- Your contributions will be licensed under the same BSL 1.1 license as the rest of the project
- After 5 years from each release, contributions automatically become available under Apache 2.0
...
5. Build: `dotnet build Kuestenlogik.Surgewave.slnx`
6. Test: `dotnet test Kuestenlogik.Surgewave.slnx`
...
2. Ensure all tests pass: `dotnet test Kuestenlogik.Surgewave.slnx`
3. Ensure zero build warnings: `dotnet build Kuestenlogik.Surgewave.slnx -c Release`
...
By contributing to Surgewave, you agree that your contributions will be licensed under the [Business Source License 1.1](LICENSE). Each version of Surgewave converts to Apache License 2.0 five years after its release date.

## Questions?

- Open a [GitHub Issue](https://github.com/Kuestenlogik/Surgewave/issues)
