...
- Die Integration ist ein **Marketing-Instrument**, kein Revenue-Träger — Revenue kommt aus Surgewave-Broker-Lizenzen (BSL) und Estuary (proprietär)
- Apache 2.0 eliminiert Adoptionshürden vollständig
- Das Paket hat eine Runtime-Abhängigkeit auf `Kuestenlogik.Surgewave.Client`, das seinerseits unter BSL lizenziert ist — die Integration selbst ist frei, der Broker erfordert eine Lizenz
...
- Die Kombination "Surgewave (BSL, kostenlos für <$1M Revenue) + MassTransit v8 (Apache 2.0)" ist ein starkes Argument gegen "Kafka + MassTransit v9 ($$$)"
