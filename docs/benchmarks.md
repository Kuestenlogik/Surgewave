...
> **Note:** Latency percentiles below are **planned targets, not measured values**.
> Run the regression suite for current numbers (see [Regression Suite](performance/regression-suite.md)).
