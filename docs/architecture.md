...
Surgewave is a Kafka-compatible streaming platform written in .NET 10/C# 14, designed as a drop-in replacement for Apache Kafka with less operational complexity (similar to Redpanda). This document describes the internal architecture and design decisions.
