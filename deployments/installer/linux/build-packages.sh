...
echo "Publishing CLI..."
dotnet publish "$REPO_ROOT/src/Kuestenlogik.Surgewave.Cli" -c Release -r $RID --self-contained -o "$BUILD_DIR/cli" -p:Version=$VERSION
...
chmod 755 "$DEB_DIR/opt/surgewave/broker/Kuestenlogik.Surgewave.Broker"
