...
public class ProcessStartupBenchmarks
{
    ...
    public void Setup()
    {
        ...
        {
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "src", "Kuestenlogik.Surgewave.Broker", "bin", "Release", "net10.0", "Kuestenlogik.Surgewave.Broker.exe"),
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "src", "Kuestenlogik.Surgewave.Broker", "bin", "Release", "net10.0", "publish", "Kuestenlogik.Surgewave.Broker.exe"),
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "artifacts", "publish", "Kuestenlogik.Surgewave.Broker", "release", "Kuestenlogik.Surgewave.Broker.exe"),
        };
